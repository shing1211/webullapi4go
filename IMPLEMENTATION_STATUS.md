...
| v2.1.4 | 2026-09-26 | Nested module coverage gate for `broker`, per-module `govulncheck`, a strict MkDocs gate, and run-index and roadmap corrections | Repository tag; not a published v2 module; offline-tested and not newly live-verified |
