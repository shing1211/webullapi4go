...
The latest repository tag is `v2.1.6` (2026-09-26). It carries the current
...
| `v2.1.6` | Repository tag only; not installable; fixes are tracked on `main` and in the repository |
| `v2.1.5` | Repository tag only; not installable; tagged with a red CI run |
| `v2.1.4` | Repository tag only; not installable; tagged with a red CI run |
