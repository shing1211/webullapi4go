...
The latest repository tag is **`v2.1.2`** (2026-09-26). Current
request-pipeline, OMS, streaming, event-telemetry, and documentation hardening
is tagged in repository `v2.1.2`, implemented, and offline-tested; it is not
...
The current hardening is recorded in repository tag `v2.1.2`. The repository's
...
the `v2.1.2` tag is not a published module version. To install the current tree,
pin a commit:
