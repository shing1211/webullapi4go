# Market Data — News — Verbatim Reference
...
> Source: <https://developer.webull.hk/apis/docs/reference/news-summary.md>
...
```json
{
  ...
  "description": "Retrieves news summary with SSE stream response.",
  "operationId": "newsSummary",
  "parameters": [
    {
      "name": "x-app-key",
      "in": "header",
    ...
    "content": {
      "application/json": {
        "schema": {
          ...
          "properties": {
            "category_symbols": {
              ...
              "items": {
                ...
                "description": "Security symbols grouped by category.",
                "title": "CategorySymbols"
              }
            },
            "lang": {
              "type": "string",
          ...
          "description": "Request parameters for news summary.",
          "title": "NewsSummaryParam"
        }
      }
    },
    "required": true
  ...
  "responses": {
    "200": {
      "description": "Server-Sent Events stream. Each message contains JSON data.<br/><br/>Example stream:<br/><code>event:message data:{\"type\":\"meta\",\"args\":{\"sessionId\":\"1\",\"convId\":451107711450219}}</code><br/><code>event:message data:{\"type\":\"text\",\"message\":\"Hi\"}</code><br/><code>event:message data:{\"type\":\"text\",\"message\":\", I'm Wally an\"}</code><br/><code>event:message data:{\"type\":\"text\",\"message\":\"d I'll help you with this question\"}</code><br/><br/>Response Types:<br/>• <b>text</b>: Markdown text<br/>• <b>table</b>: { headers: {text: \"&lt;Title&gt;\"}[], rows: {text: \"Row Text\"}[][] }"
    },
    "401": {
  ...
  "postman": {
    ...
    "description": {
      "content": "Retrieves news summary with SSE stream response.",
      "type": "text/plain"
    },
    "url": {
      "path": [
