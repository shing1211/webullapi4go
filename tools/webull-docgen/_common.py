...
AREAS["authentication"] = (
    ...
    [
        ...
        ("Refresh Client Token (Display)", HK + "market-display-solution-data-api/refresh-client-token.md", "not exposed", "The SDK re-creates the client token instead of refreshing it."),
    ],
)
...
AREAS["market-data-option"] = (
    ...
    [
        ...
        ("Option Contract List (Chain)", HK + "option-contract-list.md", "data.GetOptionContracts", "Trading API surface. Field mappings unconfirmed; HK sandbox returns 404."),
    ],
)
...
AREAS["market-data-futures"] = (
    ...
    [
        ("Futures Tick", HK + "futures-tick.md", "data.GetFuturesTick", "Paths unconfirmed against live API."),
        ("Futures Snapshot", HK + "futures-snapshot.md", "data.GetFuturesSnapshot", "Paths unconfirmed."),
        ("Futures Footprint", HK + "futures-footprint.md", "data.GetFuturesFootprint", "Paths unconfirmed."),
        ("Futures Quotes (Depth)", HK + "futures-depth-of-book.md", "data.GetFuturesDepth", "Paths unconfirmed."),
        ("Futures Historical Bars", HK + "futures-historical-bars.md", "data.GetFuturesBars", "Paths unconfirmed."),
        ("Futures Instrument List", HK + "futures-instrument-list.md", "data.GetFuturesInstruments", "Product-codes path confirmed against HK sandbox."),
        ("Futures Product Codes", HK + "futures-products.md", "data.GetFuturesProductCodes", "Confirmed against HK sandbox."),
        ("Futures Product Classes", HK + "futures-products-class.md", "data.GetFuturesProductClasses", "Unconfirmed."),
    ],
)
...
AREAS["fundamentals"] = (
    ...
    [
        ...
        ("Fund Brief", HK + "fund-brief.md", "data.GetFundInfo", "Paths unconfirmed; HK sandbox returns 404."),
        ("Fund Performance", HK + "fund-performance.md", "not implemented", "Documented but no SDK method."),
        ("Fund Net Value", HK + "fund-net-value.md", "data.GetFundNav", "Paths unconfirmed."),
        ("Fund Holdings", HK + "fund-holdings.md", "not implemented", "Documented but no SDK method."),
        ("Fund Dividends", HK + "fund-dividends.md", "data.GetFundDividends", "Paths unconfirmed."),
        ("Fund Rating", HK + "fund-rating.md", "not implemented", "Documented but no SDK method."),
        ("Fund Splits", HK + "fund-splits.md", "not implemented", "Documented but no SDK method."),
        ("Fund Files", HK + "fund-files.md", "not implemented", "Documented but no SDK method."),
        ("Fund Allocation", HK + "fund-allocation.md", "not implemented", "Documented but no SDK method."),
    ],
)
...
AREAS["event-contracts"] = (
    ...
    [
        ...
        ("Event Snapshot", US + "event-snapshot.md", "data.GetEventSnapshot", "Host/paths unconfirmed."),
        ("Event Depth", US + "event-depth.md", "data.GetEventDepth", "Host/paths unconfirmed."),
        ("Event Bars", US + "event-bars.md", "data.GetEventBars", "Host/paths unconfirmed."),
        ("Event Tick", US + "event-tick.md", "data.GetEventTick", "Host/paths unconfirmed."),
    ],
)
...
AREAS["broker-fd-us"] = (
    "Broker API — FD (US)",
    "US Broker FD surface. Documented on the US site only and marked "
    "**provisional** in this SDK: all paths require live-probe confirmation and "
    "the HK sandbox returns 404.",
    [
        ("List Accounts", US + "broker-fd-api/list-accounts.md", "brokerfd.ListFDAccounts", "Provisional."),
        ("Account Detail", US + "broker-fd-api/get-account-detail.md", "brokerfd.GetFDAccountDetail", "Provisional."),
        ("Create Account", US + "broker-fd-api/create-account-apply.md", "brokerfd.CreateFDAccount", "Provisional."),
        ("Update Account", US + "broker-fd-api/update-account-apply.md", "brokerfd.UpdateFDAccount", "Provisional."),
        ("Close Account", US + "broker-fd-api/close-account.md", "brokerfd.CloseFDAccount", "Provisional."),
        ("Account Application Detail", US + "broker-fd-api/get-account-application-detail.md", "—", "Provisional."),
        ("List Forms", US + "broker-fd-api/get-form-list.md", "brokerfd.ListAccountForms", "Provisional."),
        ("List Form Versions", US + "broker-fd-api/get-form-version-list.md", "—", "Provisional."),
        ("Form Content", US + "broker-fd-api/get-form-content.md", "—", "Provisional."),
        ("Upload Document", US + "broker-fd-api/document-upload.md", "brokerfd.UploadDocument", "Provisional."),
        ("Download Document", US + "broker-fd-api/document-download.md", "brokerfd.DownloadDocument", "Provisional."),
        ("Assets Summary", US + "broker-fd-api/summary.md", "brokerfd.GetAccountsSummary / GetFDAssetsSummary", "Provisional."),
        ("Assets Detail", US + "broker-fd-api/account-balance.md", "brokerfd.GetFDAssetsDetail", "Provisional."),
        ("Positions", US + "broker-fd-api/account-position.md", "brokerfd.GetFDPositions / GetPositions", "Provisional."),
        ("Cash Activities By Type", US + "broker-fd-api/broker-cash-activity-by-type.md", "brokerfd.GetFDActivities", "Provisional."),
        ("Create Bank Relationship", US + "broker-fd-api/create-bank-relationship.md", "brokerfd.AddFDBankAccount", "Provisional."),
        ("Delete Bank Relationship", US + "broker-fd-api/delete-bank-relationship.md", "brokerfd.RemoveFDBankAccount", "Provisional."),
        ("List Bank Accounts", US + "broker-fd-api/list-linked-bank-accounts.md", "brokerfd.ListFDBankAccounts", "Provisional."),
        ("Create ACH Relationship", US + "broker-fd-api/create-ach-relationship.md", "brokerfd.AddFDAchAccount", "Provisional."),
        ("Delete ACH Relationship", US + "broker-fd-api/delete-ach-relationship.md", "brokerfd.RemoveFDAchAccount", "Provisional."),
        ("List ACH Relationships", US + "broker-fd-api/list-ach-relationships.md", "brokerfd.ListFDAchAccounts", "Provisional."),
        ("Create Transfer", US + "broker-fd-api/create-transfer.md", "brokerfd.InitiateFDTransfer", "Provisional."),
        ("Transfer List", US + "broker-fd-api/transfer-list.md", "brokerfd.ListFDTransfers", "Provisional."),
        ("Transfer Detail", US + "broker-fd-api/transfer-detail.md", "brokerfd.GetFDTransferDetail", "Provisional."),
        ("Cancel Transfer", US + "broker-fd-api/cancel-transfer.md", "—", "Provisional."),
        ("Create Instant Funding", US + "broker-fd-api/broker-funding-instant-create.md", "brokerfd.CreateFDInstantFunding", "Provisional."),
        ("Instant Funding Detail", US + "broker-fd-api/broker-funding-instant-query.md", "brokerfd.GetFDInstantFundingDetail", "Provisional."),
        ("Create Fee", US + "broker-fd-api/broker-funding-fee-create.md", "—", "Provisional."),
        ("Get Fee", US + "broker-fd-api/broker-funding-fee-query.md", "brokerfd.GetFDTransferFees", "Provisional."),
        ("Create Credit", US + "broker-fd-api/broker-funding-credit-create.md", "—", "Provisional."),
        ("Get Credit", US + "broker-fd-api/broker-funding-credit-query.md", "brokerfd.GetFDCreditInfo", "Provisional."),
        ("List Stock Instruments", US + "broker-fd-api/list-stock-instruments.md", "brokerfd.GetFDStockInstruments", "Provisional."),
        ("Event Contract Categories", US + "broker-fd-api/broker-event-categories-list.md", "—", "Provisional."),
        ("Event Contract Series", US + "broker-fd-api/broker-event-series-list.md", "—", "Provisional."),
        ("Event Contract Events", US + "broker-fd-api/broker-event-events-list.md", "—", "Provisional."),
        ("Event Contract Instruments", US + "broker-fd-api/broker-event-market-list.md", "brokerfd.GetFDECInstruments", "Provisional."),
        ("Corporate Actions Detail", US + "broker-fd-api/broker-corporate-actions-detail.md", "brokerfd.GetFDCorporateActions", "Provisional."),
        ("Order Preview", US + "broker-fd-api/common-order-preview.md", "brokerfd.PreviewFDOrder", "Provisional."),
        ("Order Place", US + "broker-fd-api/common-order-place.md", "brokerfd.PlaceFDOrder", "Provisional."),
        ("Order Replace", US + "broker-fd-api/common-order-replace.md", "brokerfd.ReplaceFDOrder", "Provisional."),
        ("Order Cancel", US + "broker-fd-api/common-order-cancel.md", "brokerfd.CancelFDOrder", "Provisional."),
        ("Open Orders", US + "broker-fd-api/order-open.md", "brokerfd.GetFDOpenOrders", "Provisional."),
        ("Order Detail", US + "broker-fd-api/order-detail.md", "brokerfd.GetFDOrderDetail", "Provisional."),
        ("Order History", US + "broker-fd-api/order-history.md", "brokerfd.GetFDOrderHistory", "Provisional."),
        ("Create Cash Journal", US + "broker-fd-api/broker-journal-cash-create.md", "—", "Provisional."),
        ("Cash Journal Detail", US + "broker-fd-api/broker-journal-cash-query.md", "brokerfd.GetFDCashJournalDetail", "Provisional."),
        ("List Enums", US + "broker-fd-api/list-enums.md", "brokerfd.GetFDEnums", "Provisional."),
        ("Trade Calendar", US + "broker-fd-api/list-trade-calendar.md", "brokerfd.GetFDTradeCalendar", "Provisional."),
        ("List Agreements", US + "broker-fd-api/broker-list-agreements-by-type.md", "brokerfd.ListAgreements", "Provisional."),
        ("Agreement Details", US + "broker-fd-api/broker-get-agreement-details.md", "brokerfd.GetAgreementDetail", "Provisional."),
    ],
)
...
AREAS["display-solution"] = (
    ...
    "`display.Service`. Several SDK path literals are marked `TODO(ds)` and are "
    "shown with a warning.",
    [
        ("Stock Top Gainers/Losers", HK + "market-display-solution-data-api/top-gainers-using-get-new.md", "data.GetDisplayGainersLosers", "Path unconfirmed."),
        ("Top Active", HK + "market-display-solution-data-api/top-active-using-get-new.md", "data.GetDisplayTopActive", "Path unconfirmed."),
        ("Snapshot", HK + "market-display-solution-data-api/snapshot-using-get.md", "data.GetDisplaySnapshot", "Path unconfirmed."),
        ("Historical Bars (Batch)", HK + "market-display-solution-data-api/query-batch-bars-using-post.md", "data.GetDisplayBars", "Path unconfirmed."),
        ("Historical Bars (Single)", HK + "market-display-solution-data-api/bars-using-get.md", "data.GetDisplayBarsSingle", "Path unconfirmed."),
        ("Tick", HK + "market-display-solution-data-api/tick-using-get.md", "data.GetDisplayTick", "Path unconfirmed."),
        ("Quotes Depth", HK + "market-display-solution-data-api/quotes-using-get.md", "data.GetDisplayDepth", "Path unconfirmed."),
        ("News Summary", HK + "market-display-solution-data-api/watchlist-summary-using-post.md", "data.GetDSNewsSummary", "Path unconfirmed."),
        ("Market News", HK + "market-display-solution-data-api/list-news-by-market-using-get.md", "data.GetDSMarketNews", "Path unconfirmed."),
        ("Symbol News", HK + "market-display-solution-data-api/list-news-by-ticker-using-get.md", "data.GetDSSymbolNews", "Path unconfirmed."),
        ("Latest News", HK + "market-display-solution-data-api/list-latest-news-using-get.md", "data.GetDSLatestNews", "Path unconfirmed."),
        ...
        ("Batch Logos", HK + "market-display-solution-data-api/batch-logo-using-post.md", "data.GetLogos", ""),
        ("Company Profile", HK + "market-display-solution-data-api/list-company-profile-using-get.md", "data.GetDSCompanyProfile", "Path unconfirmed."),
        ("Analyst Target Price", HK + "market-display-solution-data-api/list-analyst-target-price-using-get.md", "data.GetDSAnalystTargetPrice", "Path unconfirmed."),
        ("Analyst Rating", HK + "market-display-solution-data-api/list-analyst-rating-using-get.md", "data.GetDSAnalystRating", "Path unconfirmed."),
        ("Streaming Subscribe", US + "broker-market-data-api/subscribe-using-post.md", "data.DSSubscribe", "US-site reference; path unconfirmed."),
        ("Streaming Unsubscribe", US + "broker-market-data-api/unsubscribe-using-post.md", "data.DSUnsubscribe", "US-site reference; path unconfirmed."),
    ],
)
...
AREAS["events"] = (
    ...
    [
        ...
        ("Subscribe Events (FD)", US + "fd-events/subscribe-events.md", "brokerfd/events", "Provisional; subscribe types unconfirmed."),
    ],
)
