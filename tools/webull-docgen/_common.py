...
AREAS["display-solution"] = (
    ...
    "`display.Service`.",
    [
        ("Stock Top Gainers/Losers", HK + "market-display-solution-data-api/top-gainers-using-get-new.md", "data.GetDisplayGainersLosers", ""),
        ("Top Active", HK + "market-display-solution-data-api/top-active-using-get-new.md", "data.GetDisplayTopActive", ""),
        ("Snapshot", HK + "market-display-solution-data-api/snapshot-using-get.md", "data.GetDisplaySnapshot", ""),
        ("Historical Bars (Batch)", HK + "market-display-solution-data-api/query-batch-bars-using-post.md", "data.GetDisplayBars", ""),
        ("Historical Bars (Single)", HK + "market-display-solution-data-api/bars-using-get.md", "data.GetDisplayBarsSingle", ""),
        ...
        ("News Summary", HK + "market-display-solution-data-api/watchlist-summary-using-post.md", "data.GetDSNewsSummary", ""),
        ("Market News", HK + "market-display-solution-data-api/list-news-by-market-using-get.md", "data.GetDSMarketNews", ""),
        ("Symbol News", HK + "market-display-solution-data-api/list-news-by-ticker-using-get.md", "data.GetDSSymbolNews", ""),
        ("Latest News", HK + "market-display-solution-data-api/list-latest-news-using-get.md", "data.GetDSLatestNews", ""),
        ...
        ("Company Profile", HK + "market-display-solution-data-api/list-company-profile-using-get.md", "data.GetDSCompanyProfile", ""),
        ("Analyst Target Price", HK + "market-display-solution-data-api/list-analyst-target-price-using-get.md", "data.GetDSAnalystTargetPrice", ""),
        ("Analyst Rating", HK + "market-display-solution-data-api/list-analyst-rating-using-get.md", "data.GetDSAnalystRating", ""),
        ("Streaming Subscribe", US + "broker-market-data-api/subscribe-using-post.md", "data.DSSubscribe", "US-site reference."),
        ("Streaming Unsubscribe", US + "broker-market-data-api/unsubscribe-using-post.md", "data.DSUnsubscribe", "US-site reference."),
    ],
)
...
AREAS["connect-api"] = (
    ...
    [
        ...
        ("Create Token", US + "connect-api/create-and-refresh-token.md", "connect.CreateToken", ""),
    ],
)
